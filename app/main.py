from app.data_from_json import list_of_customers, list_of_shops, fuel_price
...
def shop_trip() -> None:
    ...
    for customer in list_of_customers:
        ...
        for shop in list_of_shops:
            trip_costs = customer.fuel_costs(shop, fuel_price) \
        ...
        customer.money_after_shopping(chosen_shop, fuel_price)

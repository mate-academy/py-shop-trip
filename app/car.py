...
class Car:
    ...
    def calculate_fuel_cost(self) -> int | float:
        distance_to_shop = math.sqrt((self.shop.location[0]
                                      - self.customer_location[0])
                                     ** 2 + (self.shop.location[1]
                                             - self.customer_location[1]) ** 2)

...
class Customer:
    ...
    def optimal_shop(self, fuel_price: float) -> None | str:
        favorite_shop = ""
        dict_cost = {}
    ...
    def trip_in_shop(self, fuel_price: float) -> None:
        print(f"{self.name} has {self.money} dollars")
        optimal_shop = self.optimal_shop(fuel_price)
        for shop in Shop.shops:

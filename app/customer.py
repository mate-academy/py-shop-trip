...
class Customer:
    ...
    def calculate_distance_to_shop(self, other: int) -> float:
    ...
    def choose_shop(self, shops: list, fuel_price: float | int) -> None:
        ...
        for shop in shops:
            ...
            if self.money > total_cost:
                candidate_shops.append((shop, total_cost))

        if candidate_shops:
            best_shop, best_price = \
                sorted(candidate_shops, key=lambda a: a[1])[0]
